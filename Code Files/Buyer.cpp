...
// Parameterized constructor: passes identity to User base
// Inheritance justification: Buyer IS a User — shares all personal info
...
void Buyer::sendMessage(string receiver, string text)
{
    ...
    m.displayMessage();
    logMessage(m); // Friend function call from Message class for logging
}

// Overrides User::display() — adds budget and preferred brand
