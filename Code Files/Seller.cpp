...
// Default constructor: calls User default constructor via inheritance
Seller::Seller() : User()
{
    listingCount = 0;
    rating = 0.0;
...
// Parameterized: passes base class fields up to User constructor
// Inheritance justification: Seller IS a User — shares id, name, contact info
...
// Overrides User::display() — adds shop name and rating on top of base info
